<?php 
    $title = "The National Poster Retrospecticus — Brooklyn, NY";
	    		...
	    		<div class="note-card-cont">
					...
					<div class="event-info-cont">
						<div class="event-info-main">
							<div class="city-name">Brooklyn, NY</div>
							<p>8/23/14</br>
							<a href="http://www.thecottoncandymachine.com/" target="_blank">Cotton Candy Machine</a></p>							
							<p>6pm</br> 															 
						</div> <!-- /event-info-main -->
						<div class="event-info-deets">
							<div class="event-details-title">Address</div>
								<p><a href="https://www.google.com/maps/place/235+S+1st+St/@40.712857,-73.9583339,17z/data=!3m1!4b1!4m2!3m1!1s0x89c2595fec310adb:0xf559fa582ec2f2d" target="_blank">235 South 1st Street, Brooklyn, NY</a></p>
								<div class="event-details-title">Facebook</div>
								<p><a href="https://www.facebook.com/events/564350417007256/" target="_blank">facebook.com/events/...</a></p>
								<div class="event-details-title">w/ Featured Artist</div>
								<p><a href="http://twoarmsinc.com/" target="_blank">Two Arms Inc.</a></p>
					</div> <!-- /event-info-deets -->			
					</div><!-- /event-details-cont -->	
					<img class="ticket" src="/_img/admit-one-5.png"/>
				</div><!-- /note-card-cont -->	

				<img  class="show-poster" src="/_img/2k14-brooklyn-national-poster-retrospecticus.jpg">
				<!-- <div class="show-meta">
