<div class="players-list-mod">
	<div class="link-list">
	 	<ul class="players-list list-horiz horiz-list">
			...
			<li class="player-list-item"> <a href="http://www.campnevernice.com/" target="_blank" alt="Laura Baisden">Laura Baisden</a> </li>
			...
			<li class="player-list-item"> <a href="http://www.thebungaloo.com/" target="_blank" alt="The Bungaloo">The Bungaloo</a> </li>	
			...
			<li class="player-list-item"> <a href="http://draplin.com/" target="_blank" alt="Aaron Draplin">Aaron Draplin</a> </li>
	...
	<div class="link-list">
	 	<ul>
			...
			<li class="player-list-item"> <a href="http://joshhiggins.com/" target="_blank" alt="Josh Higgins">Josh Higgins</a> </li>							
			<li class="player-list-item"> <a href="http://www.shawnhileman.com/" target="_blank" alt="Shawn Hileman">Shawn Hileman</a> </li>
			<li class="player-list-item"> <a href="http://jackywinter.com/artists/aaron-horkey/" target="_blank" alt="Aaron Horkey">Aaron Horkey</a> </li>
			<li class="player-list-item"> <a href="http://www.houseind.com/" target="_blank" alt="House Industries">House Industries</a> </li>							
			<li class="player-list-item"> <a href="http://www.picketdesign.com/" target="_blank" alt="Tarah Hursh">Tarah Hursh</a> </li>
			<li class="player-list-item"> <a href="http://alanhynes.com/" target="_blank" alt="Alan Hynes">Alan Hynes</a> </li>								
			<li class="player-list-item"> <a href="http://www.hyp-inc.com/" target="_blank" alt="Hyp Inc">Hyp Inc</a> </li>		
			<li class="player-list-item"> <a href="http://www.isleofprinting.com/" target="_blank" alt="Isle of Printing">Isle of Printing</a> </li>			
			<li class="player-list-item"> <a href="http://boomsaidthunder.com/" target="_blank" alt="Ink Thing">Ink Thing</a> </li>									
			...
			<li class="player-list-item"> <a href="http://liltuffy.bigcartel.com/" target="_blank" alt="Lil Tuffy">Lil Tuffy</a> </li>																		
			<li class="player-list-item"> <a href="http://www.thelittlefriendsofprintmaking.com/" target="_blank" alt="Little Friends of Printmaking">Little Friends of Printmaking</a> </li>
	...
	<div class="link-list last">
	 	<ul>
			...
			<li class="player-list-item"> <a href="http://twoarmsinc.com/" target="_blank" alt="Two Arms Inc.">Two Arms Inc.</a> </li>			
			<li class="player-list-item"> <a href="http://www.uglybogus.com/" target="_blank" alt="Ugly Bogus">Ugly Bogus</a> </li>						
			<li class="player-list-item"> <a href="http://www.unionpressprints.com/" target="_blank" alt="Union Press">Union Press</a> </li>
